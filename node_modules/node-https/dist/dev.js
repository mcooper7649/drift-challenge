        ...
        switch (_b.label) {
            case 0:
                ...
                if (!url || false === /^https?:/.test(url)) {
                    return [2 /*return*/, res.status(400).json({ code: 'url_param_missing' })];
                }
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, http.request(url, req.method, options)];
            case 2:
                result = _b.sent();
                res.status(result.status).json((_a = result.data) !== null && _a !== void 0 ? _a : { body: result.body });
                return [3 /*break*/, 4];
            case 3:
                e_1 = _b.sent();
                res.status(e_1.status || 500).json(e_1.data);
                return [3 /*break*/, 4];
