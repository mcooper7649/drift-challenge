...
var Request = /** @class */ (function () {
    ...
    Request.prototype.request = function (url, method, options) {
        ...
        var requestOptions = __assign(__assign({}, parse_url_1.parseUrl(url, options.params)), { port: options.port, method: method,
            headers: headers });
        return new Promise(function (resolve, reject) {
            var req = https_1.request(requestOptions, function (res) {
